...
<html lang="en">
  ...
  <table border="1" cellspacing="0" cellpadding="20"> <!-- Membuat tabel dengan border, cellspacing, dan cellpadding -->
    ...
    <!-- while -->
    <table border="1" cellspacing="0" cellpadding="20"> <!-- Membuat tabel dengan border, cellspacing, dan cellpadding -->
      <?php $x=0; while($x<3) : $x++; ?> <!-- Inisialisasi $x=0, lalu loop selama $x < 3 (3 baris), increment $x setiap iterasi -->
      <tr> <!-- Buat baris tabel -->
        <?php $y=0; while($y<3) : $y++; ?> <!-- Inisialisasi $y=0, lalu loop selama $y < 3 (3 kolom), increment $y setiap iterasi -->
